...
module.exports = {
  purge: ['./src/**/*.tsx','./src/**/*.scss', './public/index.html'],
  presets: [],
  ...
  theme: {
    ...
    boxShadow: {
      ...
      DEFAULT: '0px 2px 13px rgba(0, 0, 0, 0.05), 0px 1px 6px rgba(0, 0, 0, 0.03)',
    ...
    fontSize: {
      "caption-2": ['0.688rem', { lineHeight: '0.813rem', letterSpacing: '0.004rem' }],
      "caption-1": ['0.75rem', { lineHeight: '1rem' }],
      "footnote": ['0.813rem', { lineHeight: '1.125rem', letterSpacing: '-0.005rem' }],
      "sub-headline": ['0.938rem', { lineHeight: '1.25rem', letterSpacing: '-0.015rem' }],
      "callout": ['1rem', { lineHeight: '1.313rem', letterSpacing: '-0.02rem' }],
      "body": ['0.875rem', { lineHeight: '1.3125rem', letterSpacing: '-0.026rem' }],
      "headline": ['1.063rem', { lineHeight: '1.375rem', letterSpacing: '-0.026rem' }],
      "title-3": ['1.25rem', { lineHeight: '1.5rem', letterSpacing: '0.024rem' }],
      "title-2": ['1.375rem', { lineHeight: '1.75rem', letterSpacing: '0.022rem' }],
      "title-1": ['1.75rem', { lineHeight: '2.125rem', letterSpacing: '0.023rem' }],
      "large-title": ['2.125rem', { lineHeight: '2.563rem', letterSpacing: '0.023rem' }],
    },
    fontWeight: {
      thin: '100',
      extralight: '200',
